...
public class ScoresAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        //mItem.setContentDescription(mH);
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.score.setText(Utilities.getScores(cursor.getInt(COL_HOME_GOALS),
                cursor.getInt(COL_AWAY_GOALS), context));
        ...
        if (mHolder.match_id == detail_match_id) {
            ...
            share_button.setContentDescription(context.getString(R.string.shareThisGame));
            share_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //add Share Action
                    context.startActivity(createShareForecastIntent(
                            String.format(context.getString(R.string.shareTextTemplate),
    ...
    public Intent createShareForecastIntent(String ShareText) {
        ...
        shareIntent.setType(mContext.getString(R.string.plainTextMimeType));
        shareIntent.putExtra(Intent.EXTRA_TEXT, ShareText +
                mContext.getString(R.string.footballScoresHashtag));
